...
class FilterPickableButton: UIView {
    ...
    private let button: UIButton = {
        ...
        button.setTitle("รับที่ร้าน", for: .normal)
    ...
    @objc private func didTapButton() {
        ...
        RestaurantFilterManager.shared.isPickable = !RestaurantFilterManager.shared.isPickable
