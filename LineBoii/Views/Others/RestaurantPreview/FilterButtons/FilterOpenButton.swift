...
class FilterOpenButton: UIView {
    ...
    private let button: UIButton = {
        ...
        button.setTitle("เปิดอยู่", for: .normal)
    ...
    @objc private func didTapButton() {
        ...
        RestaurantFilterManager.shared.isOpen = !RestaurantFilterManager.shared.isOpen
