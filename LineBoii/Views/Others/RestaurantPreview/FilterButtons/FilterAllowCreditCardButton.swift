//
//  FilterAllowCreditCardButton.swift
//  LineBoii
//
...
class FilterAllowCreditCardButton: UIView {
    ...
    override init(frame: CGRect) {
        ...
        observer = NotificationCenter.default.addObserver(
            forName: .isAllowCreditCardNotification,
            object: nil,
            queue: .main,
            using: { [weak self] _ in
                guard let strongSelf = self else {return}
                print("isAllowCreditCard current state : \(strongSelf.currentState)")
    ...
    @objc private func didTapButton() {
        ...
        RestaurantFilterManager.shared.isAllowCreditCard = !RestaurantFilterManager.shared.isAllowCreditCard
